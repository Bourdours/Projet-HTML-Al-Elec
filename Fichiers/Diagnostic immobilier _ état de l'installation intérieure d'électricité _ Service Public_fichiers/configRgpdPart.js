...
require(['orejime/orejime', 'domReady', 'jquery'], function (orejime, domReady, $) {
  var orejimeConfig = {
    ...
    stringifyCookie: function (contents) {
      ...
      return cookieValue + "; domain=" + location + "; SameSite=Lax";
    },
    ...
    translations: {
      fr: {
        ...
        consentNotice: {
          description: "Ce site utilise des cookies permettant de visualiser des contenus et d'améliorer le fonctionnement grâce aux statistiques de navigation. Si vous cliquez sur « Accepter », la Dila (éditeur du site Service Public) et ses partenaires déposeront ces cookies sur votre terminal lors de votre navigation. Si vous cliquez sur « Refuser », ces cookies ne seront pas déposés. Votre choix est conservé pendant 6 mois et vous pouvez être informé et modifier vos préférences à tout moment sur la page « Gérer les cookies »",
    ...
    apps: [
      ...
      },
      {
        ...
        title: "Vidéos",
        description: "Ils permettent la lecture de vidéos sur le site Service Public en provenance de sites d’hébergement de contenus. <a href=\"https://policies.google.com/privacy\" target=\"_blank\" title=\"politique de confidentialité de YouTube - nouvelle fenêtre\">Politique de confidentialité de YouTube</a>",
        callback: function (consent, app) {
